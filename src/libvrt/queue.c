...
static int
vrt_claim_single_threaded(struct vrt_queue *q,
...
static int
vrt_claim_multi_threaded(struct vrt_queue *q,
                             struct vrt_producer *p)
{
...
static int
vrt_publish_single_threaded(struct vrt_queue *q,
                                struct vrt_producer *p,
...
static int
vrt_publish_multi_threaded(struct vrt_queue *q,
                               struct vrt_producer *p,
                               vrt_value_id last_published_id)
{
